...
<html>
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="tools/bootstrap-5.1.3-dist/css/bootstrap.min.css" rel="stylesheet">
        ...
        <header>
            <nav class="navbar navbar-expand-lg custom navbar-light">
                <div class="container-fluid">
                    <a class="navbar-brand text-light" href="index.html">UNPA</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="cursos_impartidos.jsp">Cursos impartidos</a></li>
                                    <li><a class="dropdown-item" href="productos_actividades.jsp">Productos</a></li>
                                    <li><a class="dropdown-item" href="asignatura_mayor_afinidad.jsp">Asignaturas con mayor afinidad</a></li>
                                </ul>
                            </li> 
                        ...
                        <label class="d-flex nav-link disabled text-light">${nombre}</label>
                    </div>
                </div>
            </nav>
        </header>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group btn-open-seccion">
                                            <button type="button" class="text-light btn btn-sm btn-outline-secondary" onclick="location.href = 'seccion_docencia.jsp';">Ver sección</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
